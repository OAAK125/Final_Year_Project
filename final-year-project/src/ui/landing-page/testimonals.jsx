        ...
        <div className="mx-auto max-w-2xl text-center">
          <blockquote>
            <p className="text-lg font-medium sm:text-xl md:text-3xl">
              This platform is a game-changer; the detailed explanations and the
              active forum answered every question I had, making my CompTIA
              Security+ journey so much smoother.
            </p>
